...
extension OBDCommand.Mode1 {
    private static let propertiesMap: [OBDCommand.Mode1: CommandProperties] = [
        .pidsA: CommandProperties("0100", "Supported PIDs [01-20]", 5, .pid),
        .status: CommandProperties("0101", "Status since DTCs cleared", 5, .status),
        .freezeDTC: CommandProperties("0102", "DTC that triggered the freeze frame", 5, .singleDTC),
        .fuelStatus: CommandProperties("0103", "Fuel System Status", 3, .fuelStatus),
        .engineLoad: CommandProperties("0104", "Calculated Engine Load", 2, .percent, true),
        .coolantTemp: CommandProperties("0105", "Coolant temperature", 2, .temp, true, maxValue: 215, minValue: -40),
        .shortFuelTrim1: CommandProperties("0106", "Short Term Fuel Trim - Bank 1", 2, .percentCentered, true),
        .longFuelTrim1: CommandProperties("0107", "Long Term Fuel Trim - Bank 1", 2, .percentCentered, true),
        .shortFuelTrim2: CommandProperties("0108", "Short Term Fuel Trim - Bank 2", 2, .percentCentered, true),
        .longFuelTrim2: CommandProperties("0109", "Long Term Fuel Trim - Bank 2", 2, .percentCentered, true),
        .fuelPressure: CommandProperties("010A", "Fuel Pressure", 2, .fuelPressure, true, maxValue: 765),
        .intakePressure: CommandProperties("010B", "Intake Manifold Pressure", 2, .pressure, true, maxValue: 255),
        .rpm: CommandProperties("010C", "RPM", 3, .uas(0x07), true, maxValue: 8000),
        .speed: CommandProperties("010D", "Vehicle Speed", 2, .uas(0x09), true, maxValue: 280),
        .timingAdvance: CommandProperties("010E", "Timing Advance", 2, .timingAdvance, true, maxValue: 64, minValue: -64),
        .intakeTemp: CommandProperties("010F", "Intake Air Temp", 2, .temp, true),
        .maf: CommandProperties("0110", "Air Flow Rate (MAF)", 3, .uas(0x27), true),
        .throttlePos: CommandProperties("0111", "Throttle Position", 2, .percent, true),
        .airStatus: CommandProperties("0112", "Secondary Air Status", 2, .airStatus),
        .O2Sensor: CommandProperties("0113", "O2 Sensors Present", 2, .o2Sensors),
        .O2Bank1Sensor1: CommandProperties("0114", "O2: Bank 1 - Sensor 1 Voltage", 3, .sensorVoltage, true, maxValue: 1.275),
        .O2Bank1Sensor2: CommandProperties("0115", "O2: Bank 1 - Sensor 2 Voltage", 3, .sensorVoltage, true, maxValue: 1.275),
        .O2Bank1Sensor3: CommandProperties("0116", "O2: Bank 1 - Sensor 3 Voltage", 3, .sensorVoltage, true, maxValue: 1.275),
        .O2Bank1Sensor4: CommandProperties("0117", "O2: Bank 1 - Sensor 4 Voltage", 3, .sensorVoltage, true, maxValue: 1.275),
        .O2Bank2Sensor1: CommandProperties("0118", "O2: Bank 2 - Sensor 1 Voltage", 3, .sensorVoltage, true, maxValue: 1.275),
        .O2Bank2Sensor2: CommandProperties("0119", "O2: Bank 2 - Sensor 2 Voltage", 3, .sensorVoltage, true, maxValue: 1.275),
        .O2Bank2Sensor3: CommandProperties("011A", "O2: Bank 2 - Sensor 3 Voltage", 3, .sensorVoltage, true, maxValue: 1.275),
        .O2Bank2Sensor4: CommandProperties("011B", "O2: Bank 2 - Sensor 4 Voltage", 3, .sensorVoltage, true, maxValue: 1.275),
        .obdcompliance: CommandProperties("011C", "OBD Standards Compliance", 2, .obdCompliance),
        .O2SensorsALT: CommandProperties("011D", "O2 Sensors Present (alternate)", 2, .o2SensorsAlt),
        .auxInputStatus: CommandProperties("011E", "Auxiliary input status (power take off)", 2, .auxInputStatus),
        .runTime: CommandProperties("011F", "Engine Run Time", 3, .uas(0x12), true),
        .pidsB: CommandProperties("0120", "Supported PIDs [21-40]", 5, .pid),
        .distanceWMIL: CommandProperties("0121", "Distance Traveled with MIL on", 4, .uas(0x25), true),
        .fuelRailPressureVac: CommandProperties("0122", "Fuel Rail Pressure (relative to vacuum)", 3, .uas(0x19), true),
        .fuelRailPressureDirect: CommandProperties("0123", "Fuel Rail Pressure (direct inject)", 3, .uas(0x1B), true),
        .O2Sensor1WRVolatage: CommandProperties("0124", "02 Sensor 1 WR Lambda Voltage", 5, .sensorVoltageBig, true, maxValue: 8.192),
        .O2Sensor2WRVolatage: CommandProperties("0125", "02 Sensor 2 WR Lambda Voltage", 5, .sensorVoltageBig, true, maxValue: 8.192),
        .O2Sensor3WRVolatage: CommandProperties("0126", "02 Sensor 3 WR Lambda Voltage", 5, .sensorVoltageBig, true, maxValue: 8.192),
        .O2Sensor4WRVolatage: CommandProperties("0127", "02 Sensor 4 WR Lambda Voltage", 5, .sensorVoltageBig, true, maxValue: 8.192),
        .O2Sensor5WRVolatage: CommandProperties("0128", "02 Sensor 5 WR Lambda Voltage", 5, .sensorVoltageBig, true, maxValue: 8.192),
        .O2Sensor6WRVolatage: CommandProperties("0129", "02 Sensor 6 WR Lambda Voltage", 5, .sensorVoltageBig, true, maxValue: 8.192),
        .O2Sensor7WRVolatage: CommandProperties("012A", "02 Sensor 7 WR Lambda Voltage", 5, .sensorVoltageBig, true, maxValue: 8.192),
        .O2Sensor8WRVolatage: CommandProperties("012B", "02 Sensor 8 WR Lambda Voltage", 5, .sensorVoltageBig, true, maxValue: 8.192),
        .commandedEGR: CommandProperties("012C", "Commanded EGR", 2, .percent, true),
        .EGRError: CommandProperties("012D", "EGR Error", 2, .percentCentered, true),
        .evaporativePurge: CommandProperties("012E", "Commanded Evaporative Purge", 2, .percent, true),
        .fuelLevel: CommandProperties("012F", "Fuel Tank Level Input", 2, .percent, true),
        .warmUpsSinceDTCCleared: CommandProperties("0130", "Number of warm-ups since codes cleared", 2, .uas(0x01), true),
        .distanceSinceDTCCleared: CommandProperties("0131", "Distance traveled since codes cleared", 3, .uas(0x25), true, maxValue: 65535.0),
        .evapVaporPressure: CommandProperties("0132", "Evaporative system vapor pressure", 3, .evapPressure, true),
        .barometricPressure: CommandProperties("0133", "Barometric Pressure", 2, .pressure, true, maxValue: 255.0),
        .O2Sensor1WRCurrent: CommandProperties("0134", "02 Sensor 1 WR Lambda Current", 2, .currentCentered, true, maxValue: 128, minValue: -128),
        .O2Sensor2WRCurrent: CommandProperties("0135", "02 Sensor 2 WR Lambda Current", 2, .currentCentered, true, maxValue: 128, minValue: -128),
        .O2Sensor3WRCurrent: CommandProperties("0136", "02 Sensor 3 WR Lambda Current", 2, .currentCentered, true, maxValue: 128, minValue: -128),
        .O2Sensor4WRCurrent: CommandProperties("0137", "02 Sensor 4 WR Lambda Current", 2, .currentCentered, true, maxValue: 128, minValue: -128),
        .O2Sensor5WRCurrent: CommandProperties("0138", "02 Sensor 5 WR Lambda Current", 2, .currentCentered, true, maxValue: 128, minValue: -128),
        .O2Sensor6WRCurrent: CommandProperties("0139", "02 Sensor 6 WR Lambda Current", 2, .currentCentered, true, maxValue: 128, minValue: -128),
        .O2Sensor7WRCurrent: CommandProperties("013A", "02 Sensor 7 WR Lambda Current", 2, .currentCentered, true, maxValue: 128, minValue: -128),
        .O2Sensor8WRCurrent: CommandProperties("013B", "02 Sensor 8 WR Lambda Current", 2, .currentCentered, true, maxValue: 128, minValue: -128),
        .catalystTempB1S1: CommandProperties("013C", "Catalyst Temperature: Bank 1 - Sensor 1", 3, .uas(0x16), true),
        .catalystTempB2S1: CommandProperties("013D", "Catalyst Temperature: Bank 2 - Sensor 1", 3, .uas(0x16), true),
        .catalystTempB1S2: CommandProperties("013E", "Catalyst Temperature: Bank 1 - Sensor 2", 3, .uas(0x16), true),
        .catalystTempB2S2: CommandProperties("013F", "Catalyst Temperature: Bank 1 - Sensor 2", 3, .uas(0x16), true),
        .pidsC: CommandProperties("0140", "Supported PIDs [41-60]", 5, .pid),
        .statusDriveCycle: CommandProperties("0141", "Monitor status this drive cycle", 5, .status),
        .controlModuleVoltage: CommandProperties("0142", "Control module voltage", 3, .uas(0x0B), true),
        .absoluteLoad: CommandProperties("0143", "Absolute load value", 3, .percent, true),
        .commandedEquivRatio: CommandProperties("0144", "Commanded equivalence ratio", 3, .uas(0x1E), true),
        .relativeThrottlePos: CommandProperties("0145", "Relative throttle position", 2, .percent, true),
        .ambientAirTemp: CommandProperties("0146", "Ambient air temperature", 2, .temp, true),
        .throttlePosB: CommandProperties("0147", "Absolute throttle position B", 2, .percent, true),
        .throttlePosC: CommandProperties("0148", "Absolute throttle position C", 2, .percent, true),
        .throttlePosD: CommandProperties("0149", "Absolute throttle position D", 2, .percent, true),
        .throttlePosE: CommandProperties("014A", "Absolute throttle position E", 2, .percent, true),
        .throttlePosF: CommandProperties("014B", "Absolute throttle position F", 2, .percent, true),
        .throttleActuator: CommandProperties("014C", "Commanded throttle actuator", 2, .percent, true),
        .runTimeMIL: CommandProperties("014D", "Time run with MIL on", 3, .uas(0x12), true),
        .timeSinceDTCCleared: CommandProperties("014E", "Time since trouble codes cleared", 3, .uas(0x12), true),
        .maxValues: CommandProperties("014F", "Maximum value for various values", 6, .none),
        .maxMAF: CommandProperties("0150", "Maximum value for air flow rate from mass air flow sensor", 4, .maxMaf, true),
        .fuelType: CommandProperties("0151", "Fuel Type", 2, .fuelType),
        .ethanoPercent: CommandProperties("0152", "Ethanol fuel %", 2, .percent),
        .evapVaporPressureAbs: CommandProperties("0153", "Absolute Evap system vapor pressure", 3, .evapPressureAlt, true),
        .evapVaporPressureAlt: CommandProperties("0154", "Evap system vapor pressure", 3, .evapPressureAlt, true),
        .shortO2TrimB1: CommandProperties("0155", "Short term secondary O2 trim - Bank 1", 3, .percentCentered, true),
        .longO2TrimB1: CommandProperties("0156", "Long term secondary O2 trim - Bank 1", 3, .percentCentered, true),
        .shortO2TrimB2: CommandProperties("0157", "Short term secondary O2 trim - Bank 2", 3, .percentCentered, true),
        .longO2TrimB2: CommandProperties("0158", "Long term secondary O2 trim - Bank 2", 3, .percentCentered, true),
        .fuelRailPressureAbs: CommandProperties("0159", "Fuel rail pressure (absolute)", 3, .uas(0x1B), true),
        .relativeAccelPos: CommandProperties("015A", "Relative accelerator pedal position", 3, .percent, true),
        .hybridBatteryLife: CommandProperties("015B", "Hybrid battery pack remaining life", 3, .percent),
        .engineOilTemp: CommandProperties("015C", "Engine oil temperature", 2, .temp, true, maxValue: 215, minValue: -40),
        .fuelInjectionTiming: CommandProperties("015D", "Fuel injection timing", 3, .injectTiming, true),
        .fuelRate: CommandProperties("015E", "Engine fuel rate", 3, .fuelRate, true),
        .emissionsReq: CommandProperties("015F", "Designed emission requirements", 3, .none)
    ]

    public var properties: CommandProperties {
        return Self.propertiesMap[self]!
    }
...
extension OBDCommand.Mode6 {
    private static let propertiesMap: [OBDCommand.Mode6: CommandProperties] = [
        .MIDS_A: CommandProperties("0600", "Supported MIDs [01-20]", 0, .pid),
        .MONITOR_O2_B1S1: CommandProperties("0601", "O2 Sensor Monitor Bank 1 - Sensor 1", 0, .monitor),
        .MONITOR_O2_B1S2: CommandProperties("0602", "O2 Sensor Monitor Bank 1 - Sensor 2", 0, .monitor),
        .MONITOR_O2_B1S3: CommandProperties("0603", "O2 Sensor Monitor Bank 1 - Sensor 3", 0, .monitor),
        .MONITOR_O2_B1S4: CommandProperties("0604", "O2 Sensor Monitor Bank 1 - Sensor 4", 0, .monitor),
        .MONITOR_O2_B2S1: CommandProperties("0605", "O2 Sensor Monitor Bank 2 - Sensor 1", 0, .monitor),
        .MONITOR_O2_B2S2: CommandProperties("0606", "O2 Sensor Monitor Bank 2 - Sensor 2", 0, .monitor),
        .MONITOR_O2_B2S3: CommandProperties("0607", "O2 Sensor Monitor Bank 2 - Sensor 3", 0, .monitor),
        .MONITOR_O2_B2S4: CommandProperties("0608", "O2 Sensor Monitor Bank 2 - Sensor 4", 0, .monitor),
        .MONITOR_O2_B3S1: CommandProperties("0609", "O2 Sensor Monitor Bank 3 - Sensor 1", 0, .monitor),
        .MONITOR_O2_B3S2: CommandProperties("060A", "O2 Sensor Monitor Bank 3 - Sensor 2", 0, .monitor),
        .MONITOR_O2_B3S3: CommandProperties("060B", "O2 Sensor Monitor Bank 3 - Sensor 3", 0, .monitor),
        .MONITOR_O2_B3S4: CommandProperties("060C", "O2 Sensor Monitor Bank 3 - Sensor 4", 0, .monitor),
        .MONITOR_O2_B4S1: CommandProperties("060D", "O2 Sensor Monitor Bank 4 - Sensor 1", 0, .monitor),
        .MONITOR_O2_B4S2: CommandProperties("060E", "O2 Sensor Monitor Bank 4 - Sensor 2", 0, .monitor),
        .MONITOR_O2_B4S3: CommandProperties("060F", "O2 Sensor Monitor Bank 4 - Sensor 3", 0, .monitor),
        .MONITOR_O2_B4S4: CommandProperties("0610", "O2 Sensor Monitor Bank 4 - Sensor 4", 0, .monitor),
        .MIDS_B: CommandProperties("0620", "Supported MIDs [21-40]", 0, .pid),
        .MONITOR_CATALYST_B1: CommandProperties("0621", "Catalyst Monitor Bank 1", 0, .monitor),
        .MONITOR_CATALYST_B2: CommandProperties("0622", "Catalyst Monitor Bank 2", 0, .monitor),
        .MONITOR_CATALYST_B3: CommandProperties("0623", "Catalyst Monitor Bank 3", 0, .monitor),
        .MONITOR_CATALYST_B4: CommandProperties("0624", "Catalyst Monitor Bank 4", 0, .monitor),
        .MONITOR_EGR_B1: CommandProperties("0631", "EGR Monitor Bank 1", 0, .monitor),
        .MONITOR_EGR_B2: CommandProperties("0632", "EGR Monitor Bank 2", 0, .monitor),
        .MONITOR_EGR_B3: CommandProperties("0633", "EGR Monitor Bank 3", 0, .monitor),
        .MONITOR_EGR_B4: CommandProperties("0634", "EGR Monitor Bank 4", 0, .monitor),
        .MONITOR_VVT_B1: CommandProperties("0635", "VVT Monitor Bank 1", 0, .monitor),
        .MONITOR_VVT_B2: CommandProperties("0636", "VVT Monitor Bank 2", 0, .monitor),
        .MONITOR_VVT_B3: CommandProperties("0637", "VVT Monitor Bank 3", 0, .monitor),
        .MONITOR_VVT_B4: CommandProperties("0638", "VVT Monitor Bank 4", 0, .monitor),
        .MONITOR_EVAP_150: CommandProperties("0639", "EVAP Monitor (Cap Off / 0.150\")", 0, .monitor),
        .MONITOR_EVAP_090: CommandProperties("063A", "EVAP Monitor (0.090\")", 0, .monitor),
        .MONITOR_EVAP_040: CommandProperties("063B", "EVAP Monitor (0.040\")", 0, .monitor),
        .MONITOR_EVAP_020: CommandProperties("063C", "EVAP Monitor (0.020\")", 0, .monitor),
        .MONITOR_PURGE_FLOW: CommandProperties("063D", "Purge Flow Monitor", 0, .monitor),
        .MIDS_C: CommandProperties("0640", "Supported MIDs [41-60]", 0, .pid),
        .MONITOR_O2_HEATER_B1S1: CommandProperties("0641", "O2 Sensor Heater Monitor Bank 1 - Sensor 1", 0, .monitor),
        .MONITOR_O2_HEATER_B1S2: CommandProperties("0642", "O2 Sensor Heater Monitor Bank 1 - Sensor 2", 0, .monitor),
        .MONITOR_O2_HEATER_B1S3: CommandProperties("0643", "O2 Sensor Heater Monitor Bank 1 - Sensor 3", 0, .monitor),
        .MONITOR_O2_HEATER_B1S4: CommandProperties("0644", "O2 Sensor Heater Monitor Bank 1 - Sensor 4", 0, .monitor),
        .MONITOR_O2_HEATER_B2S1: CommandProperties("0645", "O2 Sensor Heater Monitor Bank 2 - Sensor 1", 0, .monitor),
        .MONITOR_O2_HEATER_B2S2: CommandProperties("0646", "O2 Sensor Heater Monitor Bank 2 - Sensor 2", 0, .monitor),
        .MONITOR_O2_HEATER_B2S3: CommandProperties("0647", "O2 Sensor Heater Monitor Bank 2 - Sensor 3", 0, .monitor),
        .MONITOR_O2_HEATER_B2S4: CommandProperties("0648", "O2 Sensor Heater Monitor Bank 2 - Sensor 4", 0, .monitor),
        .MONITOR_O2_HEATER_B3S1: CommandProperties("0649", "O2 Sensor Heater Monitor Bank 3 - Sensor 1", 0, .monitor),
        .MONITOR_O2_HEATER_B3S2: CommandProperties("064A", "O2 Sensor Heater Monitor Bank 3 - Sensor 2", 0, .monitor),
        .MONITOR_O2_HEATER_B3S3: CommandProperties("064B", "O2 Sensor Heater Monitor Bank 3 - Sensor 3", 0, .monitor),
        .MONITOR_O2_HEATER_B3S4: CommandProperties("064C", "O2 Sensor Heater Monitor Bank 3 - Sensor 4", 0, .monitor),
        .MONITOR_O2_HEATER_B4S1: CommandProperties("064D", "O2 Sensor Heater Monitor Bank 4 - Sensor 1", 0, .monitor),
        .MONITOR_O2_HEATER_B4S2: CommandProperties("064E", "O2 Sensor Heater Monitor Bank 4 - Sensor 2", 0, .monitor),
        .MONITOR_O2_HEATER_B4S3: CommandProperties("064F", "O2 Sensor Heater Monitor Bank 4 - Sensor 3", 0, .monitor),
        .MONITOR_O2_HEATER_B4S4: CommandProperties("0650", "O2 Sensor Heater Monitor Bank 4 - Sensor 4", 0, .monitor),
        .MIDS_D: CommandProperties("0660", "Supported MIDs [61-80]", 0, .pid),
        .MONITOR_HEATED_CATALYST_B1: CommandProperties("0661", "Heated Catalyst Monitor Bank 1", 0, .monitor),
        .MONITOR_HEATED_CATALYST_B2: CommandProperties("0662", "Heated Catalyst Monitor Bank 2", 0, .monitor),
        .MONITOR_HEATED_CATALYST_B3: CommandProperties("0663", "Heated Catalyst Monitor Bank 3", 0, .monitor),
        .MONITOR_HEATED_CATALYST_B4: CommandProperties("0664", "Heated Catalyst Monitor Bank 4", 0, .monitor),
        .MONITOR_SECONDARY_AIR_1: CommandProperties("0671", "Secondary Air Monitor 1", 0, .monitor),
        .MONITOR_SECONDARY_AIR_2: CommandProperties("0672", "Secondary Air Monitor 2", 0, .monitor),
        .MONITOR_SECONDARY_AIR_3: CommandProperties("0673", "Secondary Air Monitor 3", 0, .monitor),
        .MONITOR_SECONDARY_AIR_4: CommandProperties("0674", "Secondary Air Monitor 4", 0, .monitor),
        .MIDS_E: CommandProperties("0680", "Supported MIDs [81-A0]", 0, .pid),
        .MONITOR_FUEL_SYSTEM_B1: CommandProperties("0681", "Fuel System Monitor Bank 1", 0, .monitor),
        .MONITOR_FUEL_SYSTEM_B2: CommandProperties("0682", "Fuel System Monitor Bank 2", 0, .monitor),
        .MONITOR_FUEL_SYSTEM_B3: CommandProperties("0683", "Fuel System Monitor Bank 3", 0, .monitor),
        .MONITOR_FUEL_SYSTEM_B4: CommandProperties("0684", "Fuel System Monitor Bank 4", 0, .monitor),
        .MONITOR_BOOST_PRESSURE_B1: CommandProperties("0685", "Boost Pressure Control Monitor Bank 1", 0, .monitor),
        .MONITOR_BOOST_PRESSURE_B2: CommandProperties("0686", "Boost Pressure Control Monitor Bank 1", 0, .monitor),
        .MONITOR_NOX_ABSORBER_B1: CommandProperties("0690", "NOx Absorber Monitor Bank 1", 0, .monitor),
        .MONITOR_NOX_ABSORBER_B2: CommandProperties("0691", "NOx Absorber Monitor Bank 2", 0, .monitor),
        .MONITOR_NOX_CATALYST_B1: CommandProperties("0698", "NOx Catalyst Monitor Bank 1", 0, .monitor),
        .MONITOR_NOX_CATALYST_B2: CommandProperties("0699", "NOx Catalyst Monitor Bank 2", 0, .monitor),
        .MIDS_F: CommandProperties("06A0", "Supported MIDs [A1-C0]", 0, .pid),
        .MONITOR_MISFIRE_GENERAL: CommandProperties("06A1", "Misfire Monitor General Data", 0, .monitor),
        .MONITOR_MISFIRE_CYLINDER_1: CommandProperties("06A2", "Misfire Cylinder 1 Data", 0, .monitor),
        .MONITOR_MISFIRE_CYLINDER_2: CommandProperties("06A3", "Misfire Cylinder 2 Data", 0, .monitor),
        .MONITOR_MISFIRE_CYLINDER_3: CommandProperties("06A4", "Misfire Cylinder 3 Data", 0, .monitor),
        .MONITOR_MISFIRE_CYLINDER_4: CommandProperties("06A5", "Misfire Cylinder 4 Data", 0, .monitor),
        .MONITOR_MISFIRE_CYLINDER_5: CommandProperties("06A6", "Misfire Cylinder 5 Data", 0, .monitor),
        .MONITOR_MISFIRE_CYLINDER_6: CommandProperties("06A7", "Misfire Cylinder 6 Data", 0, .monitor),
        .MONITOR_MISFIRE_CYLINDER_7: CommandProperties("06A8", "Misfire Cylinder 7 Data", 0, .monitor),
        .MONITOR_MISFIRE_CYLINDER_8: CommandProperties("06A9", "Misfire Cylinder 8 Data", 0, .monitor),
        .MONITOR_MISFIRE_CYLINDER_9: CommandProperties("06AA", "Misfire Cylinder 9 Data", 0, .monitor),
        .MONITOR_MISFIRE_CYLINDER_10: CommandProperties("06AB", "Misfire Cylinder 10 Data", 0, .monitor),
        .MONITOR_MISFIRE_CYLINDER_11: CommandProperties("06AC", "Misfire Cylinder 11 Data", 0, .monitor),
        .MONITOR_MISFIRE_CYLINDER_12: CommandProperties("06AD", "Misfire Cylinder 12 Data", 0, .monitor),
        .MONITOR_PM_FILTER_B1: CommandProperties("06B0", "PM Filter Monitor Bank 1", 0, .monitor),
        .MONITOR_PM_FILTER_B2: CommandProperties("06B1", "PM Filter Monitor Bank 2", 0, .monitor)
    ]
...
extension OBDCommand.Mode1 {
    private static let descriptionsMap: [OBDCommand.Mode1: String] = [
        .status: "Monitor Status of the vehicle's systems",
        .freezeDTC: """
        ...
        .intakePressure: """
            ...
            """,
        .rpm: "The Engine RPM PID provides the current revolutions per minute (RPM) of the engine, indicating how fast the engine's crankshaft is rotating. This is a key parameter for monitoring engine performance and efficiency.",
        .speed: "The Vehicle Speed PID provides the current speed of the vehicle, typically in kilometers per hour (km/h) or miles per hour (mph), depending on the vehicle's configuration.",
        .timingAdvance: """
        ...
        .O2Sensor: """
            ...
            """,
        .O2Bank1Sensor1: "The Oxygen Sensor Bank 1, Sensor 1 PID provides the data from the first oxygen sensor located before the catalytic converter (also called the pre-catalytic converter O2 sensor) on Bank 1 of the engine. Bank 1 refers to the side of the engine where cylinder #1 is located, and this sensor is critical for monitoring the air-fuel mixture and ensuring proper emissions control.",
        .O2Bank1Sensor2: "The Oxygen Sensor Bank 1, Sensor 2 PID provides the data from the second oxygen sensor located after the catalytic converter on Bank 1 of the engine. This sensor is often referred to as the post-catalytic converter O2 sensor or downstream O2 sensor. It plays a crucial role in monitoring the performance of the catalytic converter and ensuring it is properly filtering the exhaust gases.",
        .O2Bank1Sensor3: "The Oxygen Sensor Bank 1, Sensor 3 PID is not part of the standard OBD-II PIDs and generally does not exist for typical gasoline vehicles. The OBD-II standard generally only defines PIDs for upstream (pre-catalytic converter) and downstream (post-catalytic converter) oxygen sensors for each bank.",
        .O2Bank1Sensor4: "Similar to Oxygen Sensor Bank 1, Sensor 3, the Oxygen Sensor Bank 1, Sensor 4 PID does not exist as part of the standard OBD-II PIDs. The OBD-II standard typically provides only two oxygen sensors per bank: one before (upstream) and one after (downstream) the catalytic converter.",
        .O2Bank2Sensor1: """
        ...
        .O2Bank2Sensor4: """
            ...
            """,
        .obdcompliance: "OBD Compliance typically refers to a vehicle’s readiness to pass emissions testing.",
        .auxInputStatus: """
        ...
        .runTimeMIL: """
            ...
            """,
        .timeSinceDTCCleared: """
            The Time Since DTC Cleared refers to the amount of time that has passed since the Diagnostic Trouble Codes (DTCs) were last cleared or reset in a vehicle's OBD-II system. This can be useful for understanding when the last diagnostic reset occurred and is often helpful in tracking how long the vehicle has been running since any issues were cleared from the system.
            ...
            """,
        .maxValues: "Max Values refer to the maximum values recorded by the vehicle’s ECU (Engine Control Unit) for certain parameters since the last DTC reset. This gives insight into how hard the engine has been worked or if it has experienced abnormal conditions.",
        .maxMAF: "The Max MAF value represents the maximum air intake measured by the Mass Air Flow (MAF) sensor since the last time the Diagnostic Trouble Codes (DTCs) were cleared. It tells you how much air the engine has ever pulled in under peak load or speed conditions.",
        .fuelType: "The Fuel Type PID tells you what type of fuel the vehicle is designed to run on, as reported by the Engine Control Unit (ECU). It’s a standardized identifier useful for diagnostics, emissions testing, and understanding how to interpret certain sensor values (since they can vary depending on the fuel type).",
        .ethanoPercent: "The Ethanol Percentage PID tells you what percentage of the fuel in the tank is ethanol. This is especially relevant for flex-fuel vehicles (FFVs) that can operate on varying blends of gasoline and ethanol (like E10, E15, or E85). Knowing this helps the ECU adjust fuel delivery and timing for optimal performance.",
        ...
        .evapVaporPressureAlt: """
            ...
            """,
        .fuelRailPressureAbs: "The Fuel Rail Pressure (Absolute) PID reports the actual pressure in the fuel rail relative to a perfect vacuum (0 kPa). This is useful for diagnosing fuel delivery issues, checking for fuel pump performance, and ensuring proper fuel injector function.",
        .relativeAccelPos: "The Relative Accelerator Pedal Position PID shows how far the accelerator pedal is pressed relative to its minimum and maximum calibrated values, not just raw voltage or angle. This PID provides a normalized percentage (0–100%), making it easier to compare across vehicles.",
        .engineOilTemp: "The Engine Oil Temperature PID provides the current temperature of the engine's lubricating oil, which is critical for monitoring engine health, thermal load, and lubrication performance. This sensor is not mandatory on all vehicles, so availability may vary.",
        .fuelInjectionTiming: "The Fuel Injection Timing PID provides the timing of fuel injection relative to the crankshaft position, typically expressed in degrees before or after top dead center (BTDC/ATDC). This is essential for understanding combustion efficiency, engine performance, and diagnosing timing-related issues.",
        .fuelRate: "The Fuel Flow Rate PID reports the rate at which fuel is being consumed by the engine. It is typically expressed in liters per hour (L/h) or gallons per hour (GPH), and is useful for monitoring fuel efficiency, consumption trends, and overall engine performance.",
        .emissionsReq: "The Emissions Requirements PID provides information about the status of emissions system readiness and compliance with the vehicle’s emission control systems. This PID is often used to check if the vehicle is ready for an emissions inspection or if any emission-related issues are affecting the vehicle’s systems."
    ]
    var detailedDescription: String? {
        return Self.descriptionsMap[self]
    }
}
