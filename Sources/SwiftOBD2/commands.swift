...
extension OBDCommand.Mode1 {
    public var properties: CommandProperties {
        ...
        case .fuelRailPressureVac: return CommandProperties("0122", "Fuel Rail Pressure (relative to vacuum)", 3, .uas(0x19), true)
        case .fuelRailPressureDirect: return CommandProperties("0123", "Fuel Rail Pressure (direct inject)", 3, .uas(0x1B), true)
        case .O2Sensor1WRVolatage: return CommandProperties("0124", "02 Sensor 1 WR Lambda Voltage", 5, .sensorVoltageBig, true, maxValue: 8.192)
        case .O2Sensor2WRVolatage: return CommandProperties("0125", "02 Sensor 2 WR Lambda Voltage", 5, .sensorVoltageBig, true, maxValue: 8.192)
        case .O2Sensor3WRVolatage: return CommandProperties("0126", "02 Sensor 3 WR Lambda Voltage", 5, .sensorVoltageBig, true, maxValue: 8.192)
        case .O2Sensor4WRVolatage: return CommandProperties("0127", "02 Sensor 4 WR Lambda Voltage", 5, .sensorVoltageBig, true, maxValue: 8.192)
        case .O2Sensor5WRVolatage: return CommandProperties("0128", "02 Sensor 5 WR Lambda Voltage", 5, .sensorVoltageBig, true, maxValue: 8.192)
        case .O2Sensor6WRVolatage: return CommandProperties("0129", "02 Sensor 6 WR Lambda Voltage", 5, .sensorVoltageBig, true, maxValue: 8.192)
        case .O2Sensor7WRVolatage: return CommandProperties("012A", "02 Sensor 7 WR Lambda Voltage", 5, .sensorVoltageBig, true, maxValue: 8.192)
        case .O2Sensor8WRVolatage: return CommandProperties("012B", "02 Sensor 8 WR Lambda Voltage", 5, .sensorVoltageBig, true, maxValue: 8.192)
        case .commandedEGR: return CommandProperties("012C", "Commanded EGR", 2, .percent, true)
        case .EGRError: return CommandProperties("012D", "EGR Error", 2, .percentCentered, true)
        case .evaporativePurge: return CommandProperties("012E", "Commanded Evaporative Purge", 2, .percent, true)
        case .fuelLevel: return CommandProperties("012F", "Fuel Tank Level Input", 2, .percent, true)
        case .warmUpsSinceDTCCleared: return CommandProperties("0130", "Number of warm-ups since codes cleared", 2, .uas(0x01), true)
        case .distanceSinceDTCCleared: return CommandProperties("0131", "Distance traveled since codes cleared", 3, .uas(0x25), true, maxValue: 65535.0)
        case .evapVaporPressure: return CommandProperties("0132", "Evaporative system vapor pressure", 3, .evapPressure, true)
        case .barometricPressure: return CommandProperties("0133", "Barometric Pressure", 2, .pressure, true, maxValue: 255.0)
        case .O2Sensor1WRCurrent: return CommandProperties("0134", "02 Sensor 1 WR Lambda Current", 2, .currentCentered, true, maxValue: 128, minValue: -128)
        case .O2Sensor2WRCurrent: return CommandProperties("0135", "02 Sensor 2 WR Lambda Current", 2, .currentCentered, true, maxValue: 128, minValue: -128)
        case .O2Sensor3WRCurrent: return CommandProperties("0136", "02 Sensor 3 WR Lambda Current", 2, .currentCentered, true, maxValue: 128, minValue: -128)
        case .O2Sensor4WRCurrent: return CommandProperties("0137", "02 Sensor 4 WR Lambda Current", 2, .currentCentered, true, maxValue: 128, minValue: -128)
        case .O2Sensor5WRCurrent: return CommandProperties("0138", "02 Sensor 5 WR Lambda Current", 2, .currentCentered, true, maxValue: 128, minValue: -128)
        case .O2Sensor6WRCurrent: return CommandProperties("0139", "02 Sensor 6 WR Lambda Current", 2, .currentCentered, true, maxValue: 128, minValue: -128)
        case .O2Sensor7WRCurrent: return CommandProperties("013A", "02 Sensor 7 WR Lambda Current", 2, .currentCentered, true, maxValue: 128, minValue: -128)
        case .O2Sensor8WRCurrent: return CommandProperties("013B", "02 Sensor 8 WR Lambda Current", 2, .currentCentered, true, maxValue: 128, minValue: -128)
        ...
        case .pidsC: return CommandProperties("0140", "Supported PIDs [41-60]", 5, .pid)
        case .statusDriveCycle: return CommandProperties("0141", "Monitor status this drive cycle", 5, .status)
        case .controlModuleVoltage: return CommandProperties("0142", "Control module voltage", 3, .uas(0x0B), true)
        case .absoluteLoad: return CommandProperties("0143", "Absolute load value", 3, .percent, true)
        case .commandedEquivRatio: return CommandProperties("0144", "Commanded equivalence ratio", 3, .uas(0x1E), true)
        case .relativeThrottlePos: return CommandProperties("0145", "Relative throttle position", 2, .percent, true)
        case .ambientAirTemp: return CommandProperties("0146", "Ambient air temperature", 2, .temp, true)
        case .throttlePosB: return CommandProperties("0147", "Absolute throttle position B", 2, .percent, true)
        case .throttlePosC: return CommandProperties("0148", "Absolute throttle position C", 2, .percent, true)
        case .throttlePosD: return CommandProperties("0149", "Absolute throttle position D", 2, .percent, true)
        case .throttlePosE: return CommandProperties("014A", "Absolute throttle position E", 2, .percent, true)
        case .throttlePosF: return CommandProperties("014B", "Absolute throttle position F", 2, .percent, true)
        case .throttleActuator: return CommandProperties("014C", "Commanded throttle actuator", 2, .percent, true)
        case .runTimeMIL: return CommandProperties("014D", "Time run with MIL on", 3, .uas(0x12), true)
        case .timeSinceDTCCleared: return CommandProperties("014E", "Time since trouble codes cleared", 3, .uas(0x12), true)
        ...
        case .evapVaporPressureAbs: return CommandProperties("0153", "Absolute Evap system vapor pressure", 3, .evapPressureAlt, true)
        case .evapVaporPressureAlt: return CommandProperties("0154", "Evap system vapor pressure", 3, .evapPressureAlt, true)
        case .shortO2TrimB1: return CommandProperties("0155", "Short term secondary O2 trim - Bank 1", 3, .percentCentered, true)
        case .longO2TrimB1: return CommandProperties("0156", "Long term secondary O2 trim - Bank 1", 3, .percentCentered, true)
        case .shortO2TrimB2: return CommandProperties("0157", "Short term secondary O2 trim - Bank 2", 3, .percentCentered, true)
        case .longO2TrimB2: return CommandProperties("0158", "Long term secondary O2 trim - Bank 2", 3, .percentCentered, true)
        case .fuelRailPressureAbs: return CommandProperties("0159", "Fuel rail pressure (absolute)", 3, .uas(0x1B), true)
