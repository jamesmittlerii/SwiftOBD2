...
extension OBDCommand.Mode1 {
    public var properties: CommandProperties {
        ...
        case .runTimeMIL: return CommandProperties("014D", "Time run with MIL on", 3, .uas(0x34), true)
        case .timeSinceDTCCleared: return CommandProperties("014E", "Time since trouble codes cleared", 3, .uas(0x34), true)
